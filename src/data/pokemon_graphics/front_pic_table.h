const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(SHELLOS_WEST, gMonFrontPic_ShellosW),
    SPECIES_SPRITE(GASTRODON_WEST, gMonFrontPic_GastrodonW),
	SPECIES_SPRITE(BASCULIN_BLUE, gMonFrontPic_BasculinBlue),
