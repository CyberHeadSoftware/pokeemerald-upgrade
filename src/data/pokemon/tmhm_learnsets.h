...
const u32 gTMHMLearnsets[][2] =
{
    ...
    [SPECIES_SHELLOS_WEST]     = TMHM_LEARNSET(TMHM(TM45_ATTRACT)
											| TMHM(TM14_BLIZZARD)
											| TMHM(HM08_DIVE)
											| TMHM(TM32_DOUBLE_TEAM)
											| TMHM(TM42_FACADE)
    ...
    [SPECIES_GASTRODON_WEST]   = TMHM_LEARNSET(TMHM(TM45_ATTRACT)
											| TMHM(TM14_BLIZZARD)
											| TMHM(TM28_DIG)
											| TMHM(HM08_DIVE)
											| TMHM(TM32_DOUBLE_TEAM)
	...
	[SPECIES_BASCULIN_BLUE]    = TMHM_LEARNSET(TMHM(TM45_ATTRACT)
											| TMHM(HM01_CUT)
											| TMHM(HM08_DIVE)
											| TMHM(TM32_DOUBLE_TEAM)
											| TMHM(TM42_FACADE)
